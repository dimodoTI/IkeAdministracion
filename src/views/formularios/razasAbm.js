...
export class pantallaRazasAbm extends connect(store)(LitElement) {
    constructor() {
        super();
        this.hidden = true
        this.idioma = "ES"
    ...
    render() {
        return html`
            ...
            <pie-componente id="gridPie" opcion="tres" media-size="${this.mediaSize}">
            </pie-componente>
...
window.customElements.define("pantalla-razasabm", pantallaRazasAbm);