        ...
        return html `
            <div id="header">
                <div style="display:grid;width:100%;grid-template-columns:90% 10%;">
                    <div id="bar">
                        <div id="lblTitulo">${idiomas[this.idioma].tramosabm.tituloCabecera}
                ...
                <div id="lblLeyenda">${idiomas[this.idioma].tramosabm.leyendaCabecera}</div>
            </div>
            <div id="cuerpo">
...
window.customElements.define("pantalla-tramosabm", pantallaTramosAbm);