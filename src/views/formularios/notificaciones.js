...
export class pantallaNotificaciones extends connect(store, MODO_PANTALLA, MASCOTAS_TIPO, RAZAS, VACUNA, MASCOTAS)(LitElement) {
            ...
            <div id="cuerpo">
                ...
                <div id="panelNotif" class="panel">
                   ...
                   <div id="divTituloForm" class="ikeInput">
                    ...
                    <div id="botonera">
                        <button btn2 @click="${this.aplicar}">Aplicar</button>
                        <button btn1 @click="${this.generar}">Generar</button>
                    </div>
    ...
    stateChanged(state, name) {
        ...
        if (name == RAZAS) {
            if (this.mascotasTipo[0]) this.filtrarRazas(this.mascotasTipo[0].Id)
            this.update()
        }
        if (name == VACUNA) {
        ...
        if (name == MASCOTAS) {
            ...
            this.status = html `
             <div class="notif">Notificacion por usuario <h4>${state.mascotas.porUsuario.length}</h4></div> 
             <div class="notif">Notificaciones por mascota <h4>${state.mascotas.entities.length}</h4></div>`
