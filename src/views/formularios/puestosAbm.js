...
import { puestoAbm } from "../componentes/puestoAbm"
...
import { get as getPuestos } from "../../redux/actions/puestos";

const MODO_PANTALLA = "ui.timeStampPantalla"
export class pantallaPuestosAbm extends connect(store, MODO_PANTALLA)(LitElement) {
    constructor() {
        super();
        this.hidden = true
        this.idioma = "ES"
...
window.customElements.define("pantalla-puestosabm", pantallaPuestosAbm);